      ...
      <div class="row">
        ...
        <!-- ini untuk petunjuk penambahan  -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('kandidat-wakil'); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Nama Wakil Ketua :</label>
                  <input type="text" class="form-control" name="nama_wakil" id="exampleInputPassword1" placeholder="Masukan Nama Ketua">
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">File Foto :</label>
                  <input type="file" name="foto_wakil" id="exampleInputFile">
                </div>
              </div>
      ...
      <!-- untuk penunjuk tambah pemilih  -->
        ...
        <div class="box box-solid">
          <div class="box-header with-border">
            ...
            <h3 class="box-title">Petunjuk Penambahan Kandidat Wakil Ketua BEM</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <ul>
