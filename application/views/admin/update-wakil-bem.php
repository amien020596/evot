      ...
      <div class="row">
        ...
        <!-- ini untuk petunjuk penambahan  -->
          <div class="box box-primary">
            ...
            <!-- form start -->
            <?php if(isset($wakil)) { ?>
            <?php foreach($wakil as $data){ ?>
            <?php echo form_open_multipart('update-kandidat-wakil/'.$data['idkandidat_BEM']); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_wakil" value="<?php echo $data['nama_wakil']; ?>" id="exampleInputPassword1" placeholder="Masukan Nama Ketua">
                </div>
                <div class="form-group">
